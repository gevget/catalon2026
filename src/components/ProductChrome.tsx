    ...
    <footer className="bg-[#12071F] px-4 pb-6 pt-16 text-white sm:px-6 lg:px-10" id="contacts">
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div><h3 className="text-xs font-bold uppercase tracking-[0.18em] text-white/40">Перевозки</h3><div className="mt-5 grid gap-3 text-sm text-white/70"><a href={baseUrl('solutions/road-freight-russia')}>По России</a><a href={baseUrl('solutions/multimodal-container')}>Мультимодальные</a><a href={baseUrl('#solutions')}>Все решения</a><a href={baseUrl('#start')}>Регистрация</a></div></div>
