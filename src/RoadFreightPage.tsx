          ...
          <div className="mx-auto max-w-[1440px] px-4 pb-16 pt-7 sm:px-6 lg:px-10 lg:pb-24">
            ...
            <div className="mt-10 grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 rounded-full bg-white/50 px-4 py-2 text-xs font-bold text-white shadow-sm backdrop-blur"><span className="h-2 w-2 animate-pulse rounded-full bg-[#6BCB00]" />Активное решение Catalon</div>
