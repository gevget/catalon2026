        ...
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <div>
            ...
            <div className="mt-10 space-y-5">
              <a href="mailto:info@catalon.ru" className="flex items-center gap-4 text-base font-semibold transition hover:text-[#7F42E1]"><span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#F0E8FA] text-[#7F42E1]"><Mail className="h-5 w-5" /></span>info@catalon.ru</a>
              ...
              <div className="flex items-center gap-4 text-base font-semibold"><span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#F0E8FA] text-[#7F42E1]"><MapPin className="h-5 w-5" /></span>Москва, Россия</div>
            </div>
          </div>
          <div className="space-y-8">
            ...
            <form className="rounded-[32px] bg-[#440D84] p-7 text-white sm:p-10" onSubmit={(event) => { event.preventDefault(); setSent(true); }}>
              ...
              <div className="mt-7 grid gap-4 sm:grid-cols-2">
                <input aria-label="Имя" placeholder="Ваше имя" className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#A0FF00]" />
                <input aria-label="Компания" placeholder="Компания" className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#A0FF00]" />
                <input aria-label="Почта" type="email" placeholder="E-mail" className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#A0FF00]" />
                <input aria-label="Телефон" type="tel" placeholder="Телефон" className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#A0FF00]" />
              </div>
              <textarea aria-label="Сообщение" placeholder="Коротко опишите задачу" rows={4} className="mt-4 w-full resize-y rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#A0FF00]" />
