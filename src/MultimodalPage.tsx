...
const audience = [
  ...
  { icon: Handshake, title: 'Транспортным партнёрам', text: 'Для крупных контейнерных линий и терминальных операторов — подключение к цифровому контуру маршрута и обмен актуальными статусами.', points: [[Link2, 'Подключение к маршруту'], [RadioTower, 'Передача статусов'], [FileCheck2, 'Данные этапа в карточке']], file: 'multimodal-partners.png' },
];
...
const faq = [
  ...
  ['Catalon сам выполняет все этапы перевозки?', 'Catalon работает как цифровой портал для заказчиков и транспортных партнёров. Конкретные этапы выполняются подключёнными участниками маршрута, а статусы и документы сохраняются в едином контуре.'],
  ...
  ['Кто координирует передачу между этапами?', 'Координация зависит от выбранной схемы маршрута и его участников. Catalon связывает этапы, статусы, документы и ответственных в одной карточке.'],
