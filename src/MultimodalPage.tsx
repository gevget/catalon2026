  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white text-[#19131F]">
      ...
      <main>
        ...
        <section className="bg-[#F6F1FB] py-20 lg:py-28"><div className="mx-auto grid max-w-[1440px] items-center gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-10"><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-[#7F42E1]">Другое активное решение</p><h2 className="mt-4 text-4xl font-extrabold tracking-[-0.04em]">Нужна автомобильная перевозка по России?</h2><p className="mt-5 max-w-xl leading-7 text-[#675F6F]">FTL / LTL перевозки, заявки, перевозчики, безопасная сделка, документы и финансирование рейса в одном портале.</p><div className="mt-8 flex flex-wrap gap-5"><a href={baseUrl('solutions/road-freight-russia')} className="inline-flex items-center gap-2 rounded-full bg-[#440D84] px-6 py-3 text-sm font-bold text-white">Подробнее <ArrowRight className="h-4 w-4" /></a><a href={baseUrl('#solutions')} className="py-3 text-sm font-bold text-[#561A9D]">Все решения Catalon</a></div></div><img src={roadImage} alt="Автомобильные грузоперевозки по России" loading="lazy" width="500" height="300" className="block h-auto w-full object-contain" /></div></section>
